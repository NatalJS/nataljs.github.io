...
var About = function About() {
  return __jsx("section", {
    ...
    className: "col-6 col-sm-12 col-md-4 col-lg-3",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 7
    },
    ...
    className: "section-title--alternate",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 11
    },
...
var CallForPapers = function CallForPapers(_ref) {
  var link = _ref.link;
  return __jsx("section", {
    id: "call-for-papers",
    ...
    __self: this
  }, "Call For Papers"), __jsx("p", {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 6
    },
    __self: this
  }, "Tem uma palestra legal? Tem algo para falar?"), __jsx("a", {
    href: link,
...
luxon__WEBPACK_IMPORTED_MODULE_1__["Settings"].defaultZoneName = 'America/Recife';

var showDateTime = function showDateTime(dateTimeISO) {
  var dateTime = luxon__WEBPACK_IMPORTED_MODULE_1__["DateTime"].fromISO(dateTimeISO);
  return dateTime.minute === 0 ? "".concat(dateTime.toFormat('HH'), "H") : "".concat(dateTime.toFormat('HH:mm'), "H");
};

var showMonthAndDay = function showMonthAndDay(startAtISO) {
  return luxon__WEBPACK_IMPORTED_MODULE_1__["DateTime"].fromISO(startAtISO).toFormat('LL.dd');
};

var showDuration = function showDuration(startAt, endAt) {
  return "".concat(showDateTime(startAt), " \xC0S ").concat(showDateTime(endAt));
};

var eventMediaClass = function eventMediaClass(index) {
  return "media event__media event__media--sticker".concat(index % 4 + 1);
};

var Events = function Events(_ref) {
  var events = _ref.events;
  var event = lodash_last__WEBPACK_IMPORTED_MODULE_2___default()(events);
  return __jsx("section", {
    id: "incoming-events",
    className: "events",
    __source: {
    ...
    __self: this
  }, showMonthAndDay(event.startAt)), __jsx("span", {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 39
    },
    __self: this
  }, showDuration(event.startAt, event.endAt))), __jsx("div", {
    className: "col-9 events__body",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 41
    },
    ...
    className: "events__location",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 43
    },
    __self: this
  }, event.address))), event.subscriptionLink && __jsx("div", {
    className: "events__block",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 47
    ...
    __self: this
  }, __jsx(_signUp__WEBPACK_IMPORTED_MODULE_3__["default"], {
    subscriptionLink: event.subscriptionLink,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 48
    },
    ...
    __self: this
  }, event.sections.map(function (section) {
    return __jsx(react__WEBPACK_IMPORTED_MODULE_0__["Fragment"], {
      ...
      className: "events__day",
      __source: {
        fileName: _jsxFileName,
        lineNumber: 54
      },
      __self: this
    }, section.title, ' ', __jsx("span", {
      __source: {
        fileName: _jsxFileName,
        lineNumber: 55
      },
      __self: this
    }, section.subtitle)), section.description && __jsx("p", {
      ...
      __self: this
    }, section.description), section.talks && __jsx("div", {
      className: "events__speakers",
      __source: {
        fileName: _jsxFileName,
        lineNumber: 61
      },
      __self: this
    }, section.talks.map(function (talk, index) {
      return __jsx("div", {
        key: talk.id,
        className: eventMediaClass(index),
        __source: {
          fileName: _jsxFileName,
          lineNumber: 63
        },
        ...
        __self: this
      }, showDateTime(talk.startAt)), __jsx("h4", {
  ...
  })), event.sponsors && event.sponsors.map(function (sponsor) {
    return __jsx("div", {
      key: sponsor.id,
...
var Footer = function Footer() {
  return __jsx("footer", {
    ...
    href: "https://www.facebook.com/nataljs/",
...
var Header = function Header() {
  return __jsx("header", {
    ...
    href: "#about",
    className: "menu__item__link scroll",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 12
    },
...
var HowTo = function HowTo() {
  return __jsx("section", {
    ...
    __self: this
  }, "Por onde come\xE7ar?"), __jsx("article", {
    className: "article col-md-12 col-lg-8",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 6
    },
    ...
    __self: this
  }, "Acompanhe nosso site, github e p\xE1ginas do Facebook e Twitter (em breve) para ficar ligado nos eventos e projetos que estamos organizando. Como comunidade flat, todos podem contribuir igualmente e se tornar membros do projeto."), __jsx("footer", {
...
/* harmony default export */ __webpack_exports__["default"] = (HowTo);

/***/ }),

/***/ "./components/JoinToUs.js":
/*!********************************!*\
  !*** ./components/JoinToUs.js ***!
  \********************************/
/*! exports provided: default */
...
var JoinToUs = function JoinToUs() {
  return __jsx("section", {
    id: "join-us",
    className: "join-us",
    __source: {
    ...
    __self: this
  }, "Fa\xE7a Parte"), __jsx("ul", {
    className: "join-us__list",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 6
    },
    ...
    className: "join-us__item",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 7
    },
    __self: this
  }, "V\xE1 aos encontros!"), __jsx("li", {
    className: "join-us__item",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 8
    ...
    __self: this
  }, "Use a hasttag #nataljs"), __jsx("li", {
    className: "join-us__item",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 9
    ...
    __self: this
  }, "Divulgue nas redes socias"), __jsx("li", {
    className: "join-us__item",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 10
...
/* harmony default export */ __webpack_exports__["default"] = (JoinToUs);
...
var SignUp = function SignUp(_ref) {
  var subscriptionLink = _ref.subscriptionLink;
  return __jsx("a", {
...
/***/ "./node_modules/@babel/runtime-corejs2/helpers/esm/interopRequireWildcard.js":
/*!***********************************************************************************!*\
  !*** ./node_modules/@babel/runtime-corejs2/helpers/esm/interopRequireWildcard.js ***!
  \***********************************************************************************/
/*! exports provided: default */
...
/***/ "./node_modules/scroll-navigation-menu/dist/scroll-navigation-menu.js":
/*!****************************************************************************!*\
  !*** ./node_modules/scroll-navigation-menu/dist/scroll-navigation-menu.js ***!
  \****************************************************************************/
/*! no static exports found */
...
/* harmony import */ var _babel_runtime_corejs2_helpers_esm_interopRequireWildcard__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @babel/runtime-corejs2/helpers/esm/interopRequireWildcard */ "./node_modules/@babel/runtime-corejs2/helpers/esm/interopRequireWildcard.js");
...
/* harmony import */ var lodash_last__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! lodash.last */ "./node_modules/lodash.last/index.js");
...
/* harmony import */ var _components_HowTo__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../components/HowTo */ "./components/HowTo.js");
/* harmony import */ var _components_Events__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../components/Events */ "./components/Events.js");
/* harmony import */ var _components_JoinToUs__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../components/JoinToUs */ "./components/JoinToUs.js");
/* harmony import */ var _components_CallForPapers__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../components/CallForPapers */ "./components/CallForPapers.js");
...
/* harmony import */ var _content_data_json__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../content/data.json */ "./content/data.json");
var _content_data_json__WEBPACK_IMPORTED_MODULE_18___namespace = /*#__PURE__*/__webpack_require__.t(/*! ../content/data.json */ "./content/data.json", 1);
/* harmony import */ var _utils_date__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ../utils/date */ "./utils/date.js");
...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_4__["default"])(Index, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      _babel_runtime_corejs2_core_js_promise__WEBPACK_IMPORTED_MODULE_1___default.a.resolve().then(function () {
        return Object(_babel_runtime_corejs2_helpers_esm_interopRequireWildcard__WEBPACK_IMPORTED_MODULE_2__["default"])(__webpack_require__(/*! ../plugins/scholl-navigation */ "./plugins/scholl-navigation.js"));
      });
    }
  }, {
    key: "render",
    value: function render() {
      ...
      var _last = lodash_last__WEBPACK_IMPORTED_MODULE_10___default()(events),
          call4papers = _last.call4papers;
      ...
      return __jsx(react__WEBPACK_IMPORTED_MODULE_8__["Fragment"], {
        ...
        __self: this
      }, "Natal.js - Comunidade para discutir javascript")), __jsx(_components_Header__WEBPACK_IMPORTED_MODULE_11__["default"], {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 36
        },
        ...
        __self: this
      }, __jsx(_components_About__WEBPACK_IMPORTED_MODULE_12__["default"], {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 38
        },
        __self: this
      }), __jsx(_components_HowTo__WEBPACK_IMPORTED_MODULE_13__["default"], {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 39
        },
        __self: this
      })), Object(_utils_date__WEBPACK_IMPORTED_MODULE_19__["isFuture"])(call4papers.endAt) && __jsx(_components_CallForPapers__WEBPACK_IMPORTED_MODULE_16__["default"], Object(_babel_runtime_corejs2_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({}, call4papers, {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 41
        },
        __self: this
      })), __jsx(_components_Events__WEBPACK_IMPORTED_MODULE_14__["default"], {
        events: events,
        __source: {
          fileName: _jsxFileName,
          lineNumber: 42
        ...
        __self: this
      }), __jsx(_components_JoinToUs__WEBPACK_IMPORTED_MODULE_15__["default"], {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 43
        },
    ...
    value: function getInitialProps() {
      var events = _content_data_json__WEBPACK_IMPORTED_MODULE_18__.events;
      return {
        events: events
      };
    }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var scroll_navigation_menu__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! scroll-navigation-menu */ "./node_modules/scroll-navigation-menu/dist/scroll-navigation-menu.js");
/* harmony import */ var scroll_navigation_menu__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(scroll_navigation_menu__WEBPACK_IMPORTED_MODULE_0__);

window.addEventListener('load', function () {
  var offset = -document.querySelector('.header').getBoundingClientRect().height;
  new scroll_navigation_menu__WEBPACK_IMPORTED_MODULE_0___default.a({
    offset: offset
  }).start();
  document.body.style.paddingTop = "".concat(offset * -1 + 2, "px");
});
